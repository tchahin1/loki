...
export const REFERENCE_CHANGED = 'reference_changed';
export const PLACE_NUMBER_CHANGED = 'place_number_changed';
export const SAVE_PLACE_SUCCESS = 'save_place_success';
export const INITIALIZE_PLACE_MODAL = 'initialize_place_modal';
